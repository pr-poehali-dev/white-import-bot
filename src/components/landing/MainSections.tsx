...
const MainSections = ({ onOpenForm }: MainSectionsProps) => {
  return (
    <main className="pt-20">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="text-base font-semibold" onClick={onOpenForm}>
                  Получить бесплатный аудит товара
                </Button>
                <Button size="lg" variant="outline" className="text-base font-semibold" onClick={onOpenForm}>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="animate-scale-in">
              <CardContent className="p-8">
                ...
                <Button className="w-full" size="lg" onClick={onOpenForm}>
      ...
      <section className="py-20 bg-gradient-to-b from-background to-primary/5">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          ...
          <Button size="lg" className="text-lg px-8 py-6" onClick={onOpenForm}>
